...
* 修改说明:
*******************************************************************************/
#ifndef _MATRIX_KEY_MAC_TBL_
#define _MATRIX_KEY_MAC_TBL_
...
// WIN键值表
unsigned char           const   matrixkey_mac_tbl[] =
{
/*
    // C0
...
// C4
    ...
    iSTD_4,             iKEY_TYPE_STD|iKEY_PRESS|iLEFT_SHIFT|iLEFT_ALT,
    iMMK_BRIGHT_ADD_L,  iKEY_TYPE_MMK|iMMK_BRIGHT_ADD_H,
    iSTD_F,             iKEY_TYPE_STD|iKEY_PRESS,       // C3 R0
    iSTD_ENTER,         iKEY_TYPE_STD|iKEY_PRESS,               //
    iMMK_BRIGHT_SUM_L,  iKEY_TYPE_MMK|iMMK_BRIGHT_SUM_H,
    iKEY_CMD_SPACE,     iKEY_TYPE_SPECIAL,
// C5
...
// C7
    ...
    iSTD_D,             iKEY_TYPE_STD|iKEY_PRESS|iLEFT_GUI|iLEFT_ALT,
...
// C16
    ...
    iSTD_SPACE,         iKEY_TYPE_STD|iKEY_PRESS|iLEFT_ALT,
