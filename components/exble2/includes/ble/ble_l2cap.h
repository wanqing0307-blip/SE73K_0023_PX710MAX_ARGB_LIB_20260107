...
__PACKED_STRUCT _ble_l2cap_header_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_command_reject_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_connection_request_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_connection_response_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_disconnection_request_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_disconnection_response_t {
    ///It represents a channel endpoint on the device sending this response.
    uint16_t DestinationCID;
    ///It represents a channel endpoint on the device receiving this response.
    uint16_t SourceCID;
...
__PACKED_STRUCT _ble_l2cap_signaling_information_request_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_connection_parameters_update_request_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_connection_parameters_update_response_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_le_connection_request_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_le_connection_response_t {
    ///It represents a channel endpoint on the device sending this response.
    uint16_t DestinationCID;
...
__PACKED_STRUCT _ble_l2cap_signaling_pdu_t {
...
__PACKED_STRUCT _ble_l2cap_signaling_pkt_t {
