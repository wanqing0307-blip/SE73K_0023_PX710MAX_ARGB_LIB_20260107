...
__PACKED_STRUCT _ble_key_distribution_t {
    uint8_t EncKey  :1;
    uint8_t IdKey   :1;
    uint8_t SignKey :1;
    uint8_t LinkKey :1;
...
__PACKED_STRUCT _ble_smp_pairing_request_response_t {
...
__PACKED_STRUCT _ble_smp_key_t {
    uint8_t Key[16];
};
typedef struct _ble_smp_key_t ble_smp_key_t;

/* 3.6.3  Master Identification */
__PACKED_STRUCT _ble_smp_master_identification_t {
    uint16_t EDIV;
    uint8_t  Rand[8];
};
...
__PACKED_STRUCT _ble_smp_identity_address_information_t {
    uint8_t AddrType;
    uint8_t BDA[6];
};
...
__PACKED_STRUCT _ble_smp_key_notification_t {
    uint8_t NotificationType;
};
typedef struct _ble_smp_key_notification_t ble_smp_key_notification_t;

/* 3.3   COMMAND FORMAT */
__PACKED_STRUCT _ble_smp_pdu_t {
...
__PACKED_STRUCT _ble_smp_pkt_t {
