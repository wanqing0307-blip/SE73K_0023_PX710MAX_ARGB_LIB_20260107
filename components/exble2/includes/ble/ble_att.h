...
typedef enum {
    ATT_ERR_NO_ERROR = 0x00, // No Error
...
__PACKED_STRUCT _ble_att_error_response_t {
...
/* 3.4.2  MTU exchange */
__PACKED_STRUCT _ble_att_exchange_mtu_request_t {
...
__PACKED_STRUCT _ble_att_exchange_mtu_response_t {
...
__PACKED_STRUCT _ble_att_find_information_request_t {
...
__PACKED_STRUCT _ble_att_find_information_response_t {
...
__PACKED_STRUCT _ble_att_find_by_type_request_t {
    ///First requested handle number.
    uint16_t StartingHandle;   //13
    ///Last requested handle number.
    uint16_t EndingHandle;     //15
...
__PACKED_STRUCT _ble_att_find_by_type_response_t {
...
__PACKED_STRUCT _ble_att_read_by_type_request_t {
    ///First requested handle number.
    uint16_t StartingHandle;   //13
    ///Last requested handle number.
    uint16_t EndingHandle;     //15
...
__PACKED_STRUCT _ble_att_read_by_type_response_t {
...
__PACKED_STRUCT _ble_att_read_request_t {
...
__PACKED_STRUCT _ble_att_read_response_t {
...
__PACKED_STRUCT _ble_att_read_blob_request_t {
    ///The handle of the attribute to be read.
    uint16_t Handle;   //13
...
__PACKED_STRUCT _ble_att_read_blob_response_t {
...
__PACKED_STRUCT _ble_att_read_by_group_type_request_t {
    ///First requested handle number.
    uint16_t StartingHandle;   //13
    ///Last requested handle number.
    uint16_t EndingHandle;     //15
...
__PACKED_STRUCT _ble_att_read_by_group_type_response_t {
    ///The size of each attribute handle-value pair.
    uint8_t Length;         //13
    ///A list of Attribute Data.
    uint8_t DataList[23-2]; //14
...
__PACKED_STRUCT _ble_att_write_request_t {
    ///The handle of the attribute to be written.
    uint16_t Handle;
    ///The value to be written to the attribute.
    #if ONMICRO_CONF_EXMIC
    uint8_t Value[23+27*2-3];
    #else
    uint8_t Value[23-3];
    #endif
};
...
__PACKED_STRUCT _ble_att_prepare_write_request_t {
  ///The handle of the attribute to be written
  uint16_t Handle;   //13
  ///The offset of the first octet to be written
  uint16_t Offset;   //15
  ///The value of the attribute to be written  
  uint8_t PartValue[23-5]; //17
};
typedef struct _ble_att_prepare_write_request_t ble_att_prepare_write_request_t;

/*3.4.6.2 Prepare Write Response */
__PACKED_STRUCT _ble_att_prepare_write_response_t {
  ///The handle of the attribute to be written
  uint16_t Handle;   //13
  ///The offset of the first octet to be written
  uint16_t Offset;   //15
...
typedef struct _ble_att_prepare_write_response_t ble_att_prepare_write_response_t;
...
__PACKED_STRUCT _ble_att_notification_indication_t {
    ///The handle of the attribute.
    uint16_t Handle;     //13
    ///The current value of the attribute.
    uint8_t Value[23-3]; //15
};
typedef struct _ble_att_notification_indication_t ble_att_notification_indication_t;

__PACKED_STRUCT _ble_att_pdu_t {
    ///Attribute Opcode
    uint8_t Opcode;    //12
    __PACKED_UNION {
        ///ATT_MTU=23
        ...
        ble_att_prepare_write_request_t       pre_write_req;
        ble_att_prepare_write_response_t      pre_write_rsp;
        ble_att_execute_write_request_t       exec_write_req;
        //ble_att_write_response_t              write_rsp;
        ble_att_write_command_t               write_cmd;
        ble_att_notification_indication_t     notify_indicate;
    } payload;
};
typedef struct _ble_att_pdu_t ble_att_pdu_t;

__PACKED_STRUCT _ble_att_pkt_t {
