...
__PACKED_STRUCT _ble_adv_header_t {
...
__PACKED_STRUCT _ble_data_header_t {
...
__PACKED_STRUCT _ble_adv_ind_t {
    uint8_t AdvA[6];
    uint8_t AdvData[31];
};
...
__PACKED_STRUCT _ble_adv_direct_ind_t {
    uint8_t AdvA[6];
    uint8_t TargetA[6];
};
...
__PACKED_STRUCT _ble_adv_nonconn_ind_t {
    uint8_t AdvA[6];
    uint8_t AdvData[31];
};
...
__PACKED_STRUCT _ble_adv_scan_ind_t {
    uint8_t AdvA[6];
    uint8_t AdvData[31];
};
...
__PACKED_STRUCT _ble_adv_scan_req_t {
    uint8_t ScanA[6];
    uint8_t AdvA[6];
};
...
__PACKED_STRUCT _ble_adv_scan_rsp_t {
    uint8_t AdvA[6];
...
__PACKED_STRUCT _ble_adv_connect_ind_t {
    uint8_t InitA[6];
    uint8_t AdvA[6];
    uint32_t AA;
    uint8_t CRCInit[3];
...
__PACKED_STRUCT _ble_adv_pkt_t {
...
__PACKED_STRUCT _ble_ll_connection_update_ind_t {
    uint8_t  WinSize;
    uint16_t WinOffset;
    uint16_t Interval;
    uint16_t Latency;
...
__PACKED_STRUCT _ble_llcp_pdu_t {
    uint8_t Opcode;
    __PACKED_UNION {
        //uint8_t                        data[23-1];
...
/* 4.4.3  scaning state */
__PACKED_STRUCT _ble_ll_scan_param {
    uint16_t scan_itvl;
...
typedef struct _ble_ll_scan_param ble_scan_param_t;

/* 4.5  Connect state */
__PACKED_STRUCT _ble_ll_conn_param
{
    uint16_t scan_itvl;
    uint16_t scan_window;
    uint8_t filter_policy;
...
typedef struct _ble_ll_conn_param ble_conn_param_t;
